...
import net.xanthian.arbiters_seal.blocks.ModChestBlock;
...
public class ChestEntityRenderer<T extends ChestBlockEntity> extends ChestBlockEntityRenderer<T> {
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (block instanceof ModChestBlock) {
            ModChestBlock chest = (ModChestBlock)block;
            ...
            float g = properties.apply(ModChestBlock.getAnimationProgressRetriever(entity)).get(tickDelta);
            g = 1.0F - g;
            g = 1.0F - g * g * g;
