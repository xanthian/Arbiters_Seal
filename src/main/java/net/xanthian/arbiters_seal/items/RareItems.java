...
public class RareItems {
    ...
    public static final Item ADAMANT_INGOT = registerItem("materials/adamant_ingot", new ModRareItem(){
        @Override
    ...
    public static final Item AEGISITE_INGOT = registerItem("materials/aegisite_ingot", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item ALOE_LEAF = registerItem("materials/aloe_leaf", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item AMMONIAC_GUM = registerItem("materials/ammoniac_gum", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item ANGEL_TEARS = registerItem("materials/angel_tears", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item CATALYST = registerItem("materials/catalyst", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item COBBLEWEED_POD = registerItem("materials/cobbleweed_pod", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item COLD_IRON_INGOT = registerItem("materials/cold_iron_ingot", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item CORONAL_PLUME = registerItem("materials/coronal_plume", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DARK_CORE = registerItem("materials/dark_core", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DEMON_LEATHER = registerItem("materials/demon_leather", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DIAMOND_THREAD = registerItem("materials/diamond_thread", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DISTILLED_WATER = registerItem("materials/distilled_water", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DORMANT_CRYSTAL = registerItem("materials/dormant_crystal", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DRAGONSBLOOD_SAP = registerItem("materials/dragonsblood_sap", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item ENERGIZED_CRYSTAL = registerItem("materials/energized_crystal", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item GODWOOD = registerItem("materials/godwood", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item GOLD_THREAD = registerItem("materials/gold_thread", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item JAMMY_FRUIT = registerItem("materials/jammy_fruit", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item METEORITE = registerItem("materials/meteorite", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item MYCOLEATHER = registerItem("materials/mycoleather", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item MYTHICAL_LEATHER = registerItem("materials/mythical_leather", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item PLATINUM_THREAD = registerItem("materials/platinum_thread", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item QUALITY_THREAD = registerItem("materials/quality_thread", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SHELLAC_POWDER = registerItem("materials/shellac_powder", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SINEWDLE_FRUIT = registerItem("materials/sinewdle_fruit", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SNAKEBITE_OIL = registerItem("materials/snakebite_oil", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A corrosive liquid with").formatted(Formatting.ITALIC, Formatting.GRAY));
            tooltip.add(Text.literal("alchemical properties.").formatted(Formatting.ITALIC, Formatting.GRAY));
    ...
    public static final Item TARNISHED_LOCKET = registerItem("materials/tarnished_locket", new ModRareItem(){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
