...
public class Helmets {
    ...
    public static final Item SILVER_CIRCLET = registerItem("helmets/silver_circlet", new ModHelmetItem(ModArmorMaterial.SILVER){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    // HEAVY
    public static final Item BRONZE_HELM = registerItem("helmets/bronze_helm", new ModHelmetItem(ModArmorMaterial.BRONZE){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("An old horseman's helmet").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item STEEL_HELM = registerItem("helmets/steel_helm", new ModHelmetItem(ModArmorMaterial.STEEL){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SILVER_HELM = registerItem("helmets/silver_helm", new ModHelmetItem(ModArmorMaterial.SILVER){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item GOLD_HELM = registerItem("helmets/gold_helm", new ModHelmetItem(ArmorMaterials.GOLD){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_HELM = registerItem("helmets/teorite_helm", new ModHelmetItem(ModArmorMaterial.TEORITE){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A thick racoon fur cap, very").formatted(Formatting.ITALIC, Formatting.GRAY));
            tooltip.add(Text.literal("warm.").formatted(Formatting.ITALIC, Formatting.GRAY));
    ...
    public static final Item DENDRITE_HELM = registerItem("helmets/dendrite_helm", new ModHelmetItem(ModArmorMaterial.DENDRITE){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
