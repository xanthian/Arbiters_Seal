...
public class WizardCone extends ModHelmetItem implements IAnimatable{
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public WizardCone(ArmorMaterial material) {
        super(material);
    }
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList.containsAll(Arrays.asList(Helmets.WIZARD_CONE));
