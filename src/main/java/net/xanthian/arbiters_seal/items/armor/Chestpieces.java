...
public class Chestpieces {
    ...
    public static final Item ARBITER_GARB = registerItem("chestpieces/arbiter_garb", new ModChestItem(ArmorMaterials.NETHERITE));
    ...
    // HEAVY
    public static final Item BRONZE_ARMOR = registerItem("chestpieces/bronze_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item STEEL_ARMOR = registerItem("chestpieces/steel_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item SILVER_ARMOR = registerItem("chestpieces/silver_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item GOLD_ARMOR = registerItem("chestpieces/gold_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item TEORITE_ARMOR = registerItem("chestpieces/teorite_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item COLD_ARMOR = registerItem("chestpieces/cold_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item ANCIENT_ARMOR = registerItem("chestpieces/ancient_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item DRAGONSCALE_MAIL = registerItem("chestpieces/dragonscale_mail", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item DENDRITE_ARMOR = registerItem("chestpieces/dendrite_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    public static final Item ARBITER_ARMOR = registerItem("chestpieces/arbiter_armor", new ModChestItem(ArmorMaterials.NETHERITE));
    ...
    public static final Item OLD_ARMOR = registerItem("chestpieces/old_armor", new ModChestItem(ArmorMaterials.NETHERITE));
