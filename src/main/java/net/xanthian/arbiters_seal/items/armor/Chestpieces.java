...
public class Chestpieces {
    ...
    // LIGHT
    public static final Item TRAVELLER_GARB = registerItem("chestpieces/traveller_garb", new ModChestItem(ArmorMaterials.LEATHER));
    ...
    public static final Item NINJA_GARB = registerItem("chestpieces/ninja_garb", new ModChestItem(ModArmorMaterial.NINJA));
