...
public class CursedShield extends ModShieldItem {
    ...
    private static final UUID ATTACK_DAMAGE_MODIFIER = UUID.fromString("a12dfe41-d73f-43d1-b88f-e255cf76bbed");
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getAttributeModifiers(ItemStack stack, EquipmentSlot slot) {
        ...
        if (slot == EquipmentSlot.MAINHAND || slot == EquipmentSlot.OFFHAND) {
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER, "Attack damage reduction", -4, EntityAttributeModifier.Operation.ADDITION));
