...
public class Daggers {
    ...
    public static final Item DAGGER = registerItem("daggers/dagger", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
    ...
    public static final Item HIDDEN_KNIFE = registerItem("daggers/hidden_knife", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("An assassin's last resort.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item DIRK = registerItem("daggers/dirk", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item EBONY_DAGGER = registerItem("daggers/ebony_dagger", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TONGUESLICER = registerItem("daggers/tongueslicer", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_DAGGER = registerItem("daggers/teorite_dagger", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item MAIN_GAUCHE = registerItem("daggers/main_gauche", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item KUNAI = registerItem("daggers/kunai", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item JANBIYA = registerItem("daggers/janbiya", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item FLASH_KINFE = registerItem("daggers/flash_knife", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item WORM_TOOTH = registerItem("daggers/worm_tooth", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DENDRITE_KNIFE = registerItem("daggers/dendrite_knife", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DRAGONS_NAIL = registerItem("daggers/dragons_nail", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
