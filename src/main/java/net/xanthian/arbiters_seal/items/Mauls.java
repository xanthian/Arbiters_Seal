...
public class Mauls {
    ...
    public static final Item SILVER_MAUL = registerItem("mauls/silver_maul", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_MAUL = registerItem("mauls/teorite_maul", new ModMaulItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
