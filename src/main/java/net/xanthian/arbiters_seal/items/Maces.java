...
public class Maces {
    ...
    public static final Item SILVER_MACE = registerItem("maces/silver_mace", new ModMaceItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_MACE = registerItem("maces/teorite_mace", new ModMaceItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
