...
public class Rapiers {
    ...
    public static final Item FLEURET = registerItem("rapiers/fleuret", new ModRapierItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
    ...
    public static final Item RAPIER = registerItem("rapiers/rapier", new ModRapierItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A bravo's dueling sabre.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item SILVER_RAPIER = registerItem("rapiers/silver_rapier", new ModRapierItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SHINING_RAPIER = registerItem("rapiers/shining_rapier", new ModRapierItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_RAPIER = registerItem("rapiers/teorite_rapier", new ModRapierItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item POISE = registerItem("rapiers/poise", new ModRapierItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item JOYEUSE = registerItem("rapiers/joyeuse", new ModRapierItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item MONARCH = registerItem("rapiers/monarch", new ModRapierItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
