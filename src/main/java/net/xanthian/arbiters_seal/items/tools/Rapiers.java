...
public class Rapiers {
    ...
    public static final Item SILVER_RAPIER = registerItem("rapiers/silver_rapier", new ModRapierItem(ModToolMaterial.SILVER, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_RAPIER = registerItem("rapiers/teorite_rapier", new ModRapierItem(ModToolMaterial.TEORITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
