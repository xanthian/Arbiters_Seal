...
public class Daggers {
    ...
    public static final Item EBONY_DAGGER = registerItem("daggers/ebony_dagger", new ModDaggerItem(ModToolMaterial.EBONY, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_DAGGER = registerItem("daggers/teorite_dagger", new ModDaggerItem(ModToolMaterial.TEORITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DENDRITE_KNIFE = registerItem("daggers/dendrite_knife", new ModDaggerItem(ModToolMaterial.DENDRITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
