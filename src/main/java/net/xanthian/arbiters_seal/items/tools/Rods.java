...
public class Rods {
    ...
    public static final Item ROD = registerItem("rods/rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A yard-long brass pole.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item ANCIENT_ROD = registerItem("rods/thumper", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SILVER_ROD = registerItem("rods/silver_rod", new ModRodItem(ModToolMaterial.SILVER, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A thick silver wand.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item WATER_ROD = registerItem("rods/water_rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item FIRE_ROD = registerItem("rods/fire_rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item EARTH_ROD = registerItem("rods/earth_rod", new ModRodItem(ModToolMaterial.TEORITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item THUNDER_ROD = registerItem("rods/thunder_rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_ROD = registerItem("rods/teorite_rod", new ModRodItem(ModToolMaterial.TEORITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item EBONY_ROD = registerItem("rods/ebony_rod", new ModRodItem(ModToolMaterial.EBONY, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item JEWELED_ROD = registerItem("rods/jeweled_rod", new ModRodItem(ToolMaterials.GOLD, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item HEAVY_ROD = registerItem("rods/heavy_rod", new ModRodItem(ModToolMaterial.STEEL, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item GLACIER_ROD = registerItem("rods/glacier_rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item BLAZING_ROD = registerItem("rods/blazing_rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item QUAKE_ROD = registerItem("rods/quake_rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SURGE_ROD = registerItem("rods/surge_rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item VOID_ROD = registerItem("rods/void_rod", new ModRodItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item PRISM_ROD = registerItem("rods/prism_rod", new ModRodItem(ToolMaterials.GOLD, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
