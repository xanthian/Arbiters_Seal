...
public class Spears {
    ...
    public static final Item SPEAR = registerItem("spears/spear", new ModSpearItem(ToolMaterials.IRON, 1, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A standard military pike.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item BOAR_SPEAR = registerItem("spears/boar_spear", new ModSpearItem(ToolMaterials.IRON, 2, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SILVER_SPEAR = registerItem("spears/silver_spear", new ModSpearItem(ModToolMaterial.SILVER, 4, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item ICESPIKE = registerItem("spears/icespike", new ModSpearItem(ToolMaterials.IRON, 3, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item FLAMESPIKE = registerItem("spears/flamespike", new ModSpearItem(ModToolMaterial.TEORITE, 3, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item STONESPIKE = registerItem("spears/stonespike", new ModSpearItem(ToolMaterials.IRON, 3, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item BOLTSPIKE = registerItem("spears/boltspike", new ModSpearItem(ToolMaterials.IRON, 3, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_SPEAR = registerItem("spears/teorite_spear", new ModSpearItem(ModToolMaterial.TEORITE, 4, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item LANCE = registerItem("spears/lance", new ModSpearItem(ToolMaterials.IRON, 3, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A heavy cavalry lance.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item PARTISAN = registerItem("spears/partisan", new ModSpearItem(ToolMaterials.DIAMOND, 3, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item HEAVY_LANCE = registerItem("spears/heavy_lance", new ModSpearItem(ToolMaterials.DIAMOND, 3, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item GODRAY = registerItem("spears/godray", new ModSpearItem(ToolMaterials.NETHERITE, 3, -3.0F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
