...
public class Swords {
    ...
    public static final Item SHORTSWORD = registerItem("swords/shortsword", new ModSwordItem(ToolMaterials.IRON, 1, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A soldiers truest friend.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item LONGSWORD = registerItem("swords/longsword", new ModSwordItem(ToolMaterials.IRON, 2, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A blade for a valorous knight.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item SILVER_SWORD = registerItem("swords/silver_sword", new ModSwordItem(ModToolMaterial.SILVER, 4, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TOOTHED_SWORD = registerItem("swords/toothed_sword", new ModSwordItem(ToolMaterials.IRON, 2, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_SWORD = registerItem("swords/teorite_sword", new ModSwordItem(ModToolMaterial.TEORITE, 3, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item ICEBRAND = registerItem("swords/icebrand", new ModSwordItem(ToolMaterials.IRON, 3, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item FLAMEBRAND = registerItem("swords/flamebrand", new ModSwordItem(ToolMaterials.IRON, 3, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item STONEBRAND = registerItem("swords/stonebrand", new ModSwordItem(ToolMaterials.IRON, 3, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item BOLTBRAND = registerItem("swords/boltbrand", new ModSwordItem(ToolMaterials.IRON, 3, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item ENHANCER = registerItem("swords/enhancer", new ModSwordItem(ToolMaterials.IRON, 4, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item EBONY_SWORD = registerItem("swords/ebony_sword", new ModSwordItem(ModToolMaterial.EBONY, 3, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item GUARDIAN_SWORD = registerItem("swords/guardian_sword", new ModSwordItem(ToolMaterials.DIAMOND, 3, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DENDRITE_SWORD = registerItem("swords/dendrite_sword", new ModSwordItem(ModToolMaterial.DENDRITE, 3, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SINGING_SWORD = registerItem("swords/singing_sword", new ModSwordItem(ToolMaterials.DIAMOND, 4, -2.3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item EXCALIBUR = registerItem("swords/excalibur", new ModSwordItem(ToolMaterials.DIAMOND, 4, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item ETERNIAS = registerItem("swords/eternias", new ModSwordItem(ToolMaterials.NETHERITE, 3, -2.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item SOUL_EATER = registerItem("swords/soul_eater", new ModSwordItem(ToolMaterials.NETHERITE, 4, -2.4F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
