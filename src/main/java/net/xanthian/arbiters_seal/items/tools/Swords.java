...
public class Swords {
    ...
    public static final Item TEORITE_SWORD = registerItem("swords/teorite_sword", new ModSwordItem(ModToolMaterial.TEORITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item EBONY_SWORD = registerItem("swords/ebony_sword", new ModSwordItem(ModToolMaterial.EBONY, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DENDRITE_SWORD = registerItem("swords/dendrite_sword", new ModSwordItem(ModToolMaterial.DENDRITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
