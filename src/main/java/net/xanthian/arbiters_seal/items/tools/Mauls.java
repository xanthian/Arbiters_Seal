...
public class Mauls {
    ...
    public static final Item MAUL = registerItem("mauls/maul", new ModMaulItem(ToolMaterials.IRON, 3, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A heavy mining hammer.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item SLEDGE = registerItem("mauls/sledge", new ModMaulItem(ToolMaterials.IRON, 3, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A blacksmith's favorite tool").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item SILVER_MAUL = registerItem("mauls/silver_maul", new ModMaulItem(ModToolMaterial.SILVER, 6, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A maul of solid silver.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item HIGH_STRIKER = registerItem("mauls/high_striker", new ModMaulItem(ToolMaterials.DIAMOND, 3, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_MAUL = registerItem("mauls/teorite_maul", new ModMaulItem(ModToolMaterial.TEORITE, 4, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item GADA = registerItem("mauls/gada", new ModMaulItem(ToolMaterials.NETHERITE, 3, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item PESTILENCE = registerItem("mauls/pestilence", new ModMaulItem(ToolMaterials.NETHERITE, 3, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item CLOCKWORK_HAMMER = registerItem("mauls/clockwork_hammer", new ModMaulItem(ToolMaterials.NETHERITE, 3, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item FLATTENER = registerItem("mauls/flattener", new ModMaulItem(ToolMaterials.GOLD, 8, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item BONECRUSHER = registerItem("mauls/bonecrusher", new ModMaulItem(ToolMaterials.NETHERITE, 4, -3.2F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
