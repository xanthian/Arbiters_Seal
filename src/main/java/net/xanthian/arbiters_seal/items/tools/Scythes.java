...
public class Scythes {
    ...
    public static final Item PLOW = registerItem("scythes/plow", new ModScytheItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
    ...
    public static final Item SCYTHE = registerItem("scythes/scythe", new ModScytheItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A scythe built for battle.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item SILVER_SCYTHE = registerItem("scythes/silver_scythe", new ModScytheItem(ModToolMaterial.SILVER, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item CRIMSON_SCYTHE = registerItem("scythes/crimson_scythe", new ModScytheItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_SCYTHE = registerItem("scythes/teorite_scythe", new ModScytheItem(ModToolMaterial.TEORITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item FAUCHARD = registerItem("scythes/fauchard", new ModScytheItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("A long-bladed polearm.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item ENERGY_SCYTHE = registerItem("scythes/energy_scythe", new ModScytheItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item KAMAITACHI = registerItem("scythes/kamaitachi", new ModScytheItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DAYS_HARVEST = registerItem("scythes/days_harvest", new ModScytheItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item REAPER = registerItem("scythes/reaper", new ModScytheItem(ToolMaterials.NETHERITE, 3, 3F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
