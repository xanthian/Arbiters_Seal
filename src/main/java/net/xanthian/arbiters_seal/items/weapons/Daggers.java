...
public class Daggers {
    ...
    public static final Item DAGGER = registerItem("daggers/dagger", new ModDaggerItem(ToolMaterials.IRON, 1, -1.8F){
        @Override
    ...
    public static final Item HIDDEN_KNIFE = registerItem("daggers/hidden_knife", new ModDaggerItem(ToolMaterials.IRON, 1, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(Text.literal("An assassin's last resort.").formatted(Formatting.ITALIC, Formatting.GRAY));
        }});

    public static final Item DIRK = registerItem("daggers/dirk", new ModDaggerItem(ToolMaterials.IRON, 2, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item EBONY_DAGGER = registerItem("daggers/ebony_dagger", new ModDaggerItem(ModToolMaterial.EBONY, 1, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TONGUESLICER = registerItem("daggers/tongueslicer", new ModDaggerItem(ToolMaterials.IRON, 2, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item TEORITE_DAGGER = registerItem("daggers/teorite_dagger", new ModDaggerItem(ModToolMaterial.TEORITE, 2, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item KUNAI = registerItem("daggers/kunai", new ModDaggerItem(ToolMaterials.IRON, 3, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item JANBIYA = registerItem("daggers/janbiya", new ModDaggerItem(ToolMaterials.GOLD, 5, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item FLASH_KINFE = registerItem("daggers/flash_knife", new ModDaggerItem(ToolMaterials.IRON, 3, -1.5F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item WORM_TOOTH = registerItem("daggers/worm_tooth", new ModDaggerItem(ToolMaterials.IRON, 3, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DENDRITE_KNIFE = registerItem("daggers/dendrite_knife", new ModDaggerItem(ModToolMaterial.DENDRITE, 3, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    public static final Item DRAGONS_NAIL = registerItem("daggers/dragons_nail", new ModDaggerItem(ToolMaterials.DIAMOND, 3, -1.8F){
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
